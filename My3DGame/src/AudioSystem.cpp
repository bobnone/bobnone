...
bool AudioSystem::Initialize()
{
	...
	result = mSystem->initialize(512/*Max number of concurrent sounds*/, FMOD_STUDIO_INIT_NORMAL/*Use default settings*/, FMOD_INIT_NORMAL/*Use default settings*/, nullptr /*Usually null*/);
	if (result != FMOD_OK)
	{
...
void AudioSystem::LoadBank(const std::string& name)
{
	...
	FMOD_RESULT result = mSystem->loadBankFile(name.c_str()/*File name of bank*/, FMOD_STUDIO_LOAD_BANK_NORMAL/*Normal loading*/, &bank/*Save pointer to bank*/);
...
void AudioSystem::SetListener(class Actor* mOwner, const matrix4& viewMatrix)
{
	...
	// Set velocity
	listener.velocity = VecToFMOD(mOwner->GetVelocity());
	// Send to FMOD
